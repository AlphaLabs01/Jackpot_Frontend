...
const t = [
  ...
  },
  {
    ...
    location: "Faridabad",
    summary:
      "�Winning isn�t everything, but it beats anything that comes in second. Bam!!!!!!!!!�",
    difficulty: "hard",
    loading: "Show Charts",
  },
  {
...
class App extends Component {
  ...
  openChart = (value) => {
    ...
    console.log(value);
    var Url =
      "http://13.59.47.18:8081/home/getChartData?region=" + value.toLowerCase();
    console.log(Url);
    ...
    axios({
      ...
      window.open(`${domain}/charts`, "_blank"); //to open new page
  ...
  render() {
    ...
    return (
      ...
      <div className="App">
        ...
        <Header
          aboutClick={this.openAboutUs}
          chartsClick={this.openChart}
        ></Header>
